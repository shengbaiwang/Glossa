; Glossa NSIS Installer Hooks
; Registers/unregisters the thumbnail provider DLL for Windows Explorer thumbnails

!include "LogicLib.nsh"

; CLSID for the thumbnail provider retained for installation compatibility
...
!macro NSIS_HOOK_POSTINSTALL
    DetailPrint "Registering Glossa Thumbnail Provider..."
    ...
    WriteRegStr HKCR "CLSID\${CLSID_READEST_THUMBNAIL}" "" "Glossa Thumbnail Provider"
...
!macro NSIS_HOOK_PREUNINSTALL
    DetailPrint "Unregistering Glossa Thumbnail Provider..."
